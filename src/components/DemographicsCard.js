  ...
  return (
    <div className="h-full px-4">
      <div className="flex h-full">
          ...
          <div className="absolute bottom-4 left-4 flex items-center space-x-4">
            {countries.map(country => (
              <div key={country.name} className="flex items-center">
                ...
                <span className="text-white text-[12px] font-semibold tracking-[-0.04em] leading-[100%]">{country.name}</span>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="w-[35%] pl-8 space-y-5 pt-4">
          {countries.map(country => (
            <div key={country.name} className="flex items-center justify-between">
              <div className="flex items-center">
                ...
                />
                <span className="text-white text-[14px] font-semibold tracking-[-0.04em] leading-[100%]">{country.name}</span>
              </div>
              <div className="flex items-center space-x-2">
                ...
                <span className="text-white text-[12px] font-semibold tracking-[-0.04em] leading-[100%]">{country.percentage}%</span>
              </div>
            </div>
          ))}
          
          <div className="pt-6 flex justify-end">
            <button className="flex items-center text-white text-[10px] font-semibold leading-[100%]">
              View all countries
